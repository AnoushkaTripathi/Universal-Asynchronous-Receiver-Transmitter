...
set_property PACKAGE_PIN T8 [get_ports {rx_empty}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {rx_empty}]
##Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
set_property PACKAGE_PIN V9 [get_ports {tx_full}]					
...
set_property PACKAGE_PIN R10 [get_ports rd_uart]						
	set_property IOSTANDARD LVCMOS33 [get_ports rd_uart]
##Bank = 14, Pin name = IO_L21P_T3_DQS_14,					Sch name = BTND
set_property PACKAGE_PIN V10 [get_ports wr_uart]						
